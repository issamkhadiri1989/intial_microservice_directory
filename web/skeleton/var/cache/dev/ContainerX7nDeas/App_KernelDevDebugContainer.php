...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).'/vendor/symfony/ai-platform/src/Contract/JsonSchema/Factory.php';
            include_once \dirname(__DIR__, 4).'/vendor/symfony/ai-platform/src/Contract/JsonSchema/DescriptionParser.php';
            include_once \dirname(__DIR__, 4).'/vendor/symfony/ai-agent/src/Toolbox/ToolFactoryInterface.php';
            include_once \dirname(__DIR__, 4).'/vendor/symfony/ai-agent/src/Toolbox/ToolFactory/AbstractToolFactory.php';
            include_once \dirname(__DIR__, 4).'/vendor/symfony/ai-agent/src/Toolbox/ToolFactory/ReflectionToolFactory.php';
            include_once \dirname(__DIR__, 4).'/vendor/symfony/ai-agent/src/Toolbox/ToolCallArgumentResolver.php';
            include_once \dirname(__DIR__, 4).'/vendor/symfony/ai-agent/src/Toolbox/ToolboxInterface.php';
            include_once \dirname(__DIR__, 4).'/vendor/symfony/ai-bundle/src/Profiler/TraceableToolbox.php';
            include_once \dirname(__DIR__, 4).'/vendor/symfony/ai-agent/src/Toolbox/Toolbox.php';
            ...
            include_once \dirname(__DIR__, 4).'/vendor/symfony/ai-bundle/src/Profiler/DataCollector.php';
    ...
    protected static function get_Container_Private_ProfilerService($container)
    {
        ...
        $instance->add(new \Symfony\AI\AiBundle\Profiler\DataCollector(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['ai.traceable_platform.gemini'] ?? $container->load('getAi_TraceablePlatform_GeminiService'));
        }, 1), ($container->privates['ai.traceable_toolbox'] ?? self::getAi_TraceableToolboxService($container)), new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['ai.traceable_toolbox'] ?? self::getAi_TraceableToolboxService($container));
            yield 1 => ($container->privates['ai.traceable_toolbox.gemini'] ?? $container->load('getAi_TraceableToolbox_GeminiService'));
        }, 2)));
        $instance->add($f);
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('Symfony\\AI\\Agent\\Toolbox\\Event\\ToolCallArgumentsResolved', [#[\Closure(name: 'ai.security.is_granted_attribute_listener', class: 'Symfony\\AI\\AiBundle\\Security\\EventListener\\IsGrantedToolAttributeListener')] fn () => ($container->privates['ai.security.is_granted_attribute_listener'] ?? $container->load('getAi_Security_IsGrantedAttributeListenerService')), '__invoke'], 0);
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\AiController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    /**
     * Gets the private 'ai.platform.json_schema_factory' shared service.
     *
     * @return \Symfony\AI\Platform\Contract\JsonSchema\Factory
     */
    protected static function getAi_Platform_JsonSchemaFactoryService($container)
    {
        return $container->privates['ai.platform.json_schema_factory'] = new \Symfony\AI\Platform\Contract\JsonSchema\Factory(new \Symfony\AI\Platform\Contract\JsonSchema\DescriptionParser(), ($container->privates['type_info.resolver'] ?? self::getTypeInfo_ResolverService($container)));
    }

    /**
     * Gets the private 'ai.tool_call_argument_resolver' shared service.
     *
     * @return \Symfony\AI\Agent\Toolbox\ToolCallArgumentResolver
     */
    protected static function getAi_ToolCallArgumentResolverService($container)
    {
        $a = ($container->privates['debug.serializer'] ?? self::getDebug_SerializerService($container));

        if (isset($container->privates['ai.tool_call_argument_resolver'])) {
            return $container->privates['ai.tool_call_argument_resolver'];
        }

        return $container->privates['ai.tool_call_argument_resolver'] = new \Symfony\AI\Agent\Toolbox\ToolCallArgumentResolver($a, ($container->privates['type_info.resolver'] ?? self::getTypeInfo_ResolverService($container)));
    }

    /**
     * Gets the private 'ai.tool_factory' shared service.
     *
     * @return \Symfony\AI\Agent\Toolbox\ToolFactory\ReflectionToolFactory
     */
    protected static function getAi_ToolFactoryService($container)
    {
        return $container->privates['ai.tool_factory'] = new \Symfony\AI\Agent\Toolbox\ToolFactory\ReflectionToolFactory(($container->privates['ai.platform.json_schema_factory'] ?? self::getAi_Platform_JsonSchemaFactoryService($container)));
    }

    /**
     * Gets the private 'ai.traceable_toolbox' shared service.
     *
     * @return \Symfony\AI\AiBundle\Profiler\TraceableToolbox
     */
    protected static function getAi_TraceableToolboxService($container)
    {
        $a = ($container->services['event_dispatcher'] ?? self::getEventDispatcherService($container));

        if (isset($container->privates['ai.traceable_toolbox'])) {
            return $container->privates['ai.traceable_toolbox'];
        }

        return $container->privates['ai.traceable_toolbox'] = new \Symfony\AI\AiBundle\Profiler\TraceableToolbox(new \Symfony\AI\Agent\Toolbox\Toolbox(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['App\\Ai\\Tool\\Tokenizer'] ??= new \App\Ai\Tool\Tokenizer());
            yield 1 => ($container->privates['Symfony\\AI\\Agent\\Toolbox\\Tool\\SerpApi'] ?? $container->load('getSerpApiService'));
        }, 2), ($container->privates['ai.tool_factory'] ?? self::getAi_ToolFactoryService($container)), ($container->privates['ai.tool_call_argument_resolver'] ?? self::getAi_ToolCallArgumentResolverService($container)), ($container->privates['monolog.logger'] ?? self::getMonolog_LoggerService($container)), $a));
    }
    ...
    protected static function getTwigService($container)
    {
        ...
        $a->addPath((\dirname(__DIR__, 4).'/vendor/symfony/maker-bundle/templates'), '!Maker');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/symfony/ai-bundle/templates'), 'Ai');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/symfony/ai-bundle/templates'), '!Ai');
     ...
     */
    protected static function getTypeInfo_ResolverService($container)
    {
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'AiBundle' => 'Symfony\\AI\\AiBundle\\AiBundle',
            ],
            'kernel.bundles_metadata' => [
                ...
                'AiBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/symfony/ai-bundle'),
            ...
            'data_collector.templates' => [
                ...
                'ai.data_collector' => [
                    0 => 'Symfony\\AI\\AiBundle\\Profiler\\DataCollector',
                    1 => '@Ai/data_collector.html.twig',
                ],
